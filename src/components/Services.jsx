...
const Services = () => {
  return (
    <section id="services" className="mt-8 px-6 md:px-0 lg:w-[80vw] m-auto ">
      ...
      <div className="sm:px-12 flex flex-col justify-center sm:gap-12 gap-6 items-center md:flex-row sm:justify-evenly mt-6 ">
        <div className="bg-slate-700 bg-opacity-[0.65] shadow-lg rounded-sm h-48 w-full   flex flex-col p-8 gap-8">
          <BsGlobe size={50} className="text-[#81E6D9]" />
          <h3 className="text-md sm:text-lg">Web Developement</h3>
        </div>
        <div className="bg-slate-700 bg-opacity-[0.65] shadow-lg rounded-sm h-48 w-full  flex flex-col p-8 gap-8">
          <AiOutlineMobile size={50} className="text-[#81E6D9]" />
