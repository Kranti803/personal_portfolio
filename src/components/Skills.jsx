  ...
  return (
    <section id="skills" className=" mt-8 px-6 lg:w-[80vw] m-auto ">
      ...
      <div className="grid gap-8 grid-cols-2 sm:grid-cols-4 pt-6">
        {skills.map((item) => (
          <div key={item.id} className="bg-slate-700 bg-opacity-[0.2] rounded-md hover:text-[#81E6D9] min-h-[125px] flex flex-col text-center items-center justify-center shadow-lg">
            <Image
              src={item.imageSrc}
